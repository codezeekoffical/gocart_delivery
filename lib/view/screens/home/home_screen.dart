...
import '../request/widget/order_requset_widget.dart';
...
class HomeScreen extends StatelessWidget {
          ...
          child: GetBuilder<AuthController>(builder: (authController) {
            ...
            return Column(children: [
              ...
              GetBuilder<OrderController>(builder: (orderController) {
                ...
                bool _hascurrentOrder = orderController.latestOrderList == null || orderController.latestOrderList.length > 0;
                ...
                return Column(children: [
                  ...
                  ) : _hascurrentOrder ? _navigateRequestPage() ? TitleWidget(
                    title: 'pending_order'.tr, onTap: _hasMoreOrder ? () {
                    Get.toNamed(RouteHelper.getRunningOrderRoute(), arguments: RunningOrderScreen());
                  } : null,
                  ) :SizedBox() : SizedBox(),


                  SizedBox(height: _hasActiveOrder ? Dimensions.PADDING_SIZE_EXTRA_SMALL : _hascurrentOrder ? Dimensions.PADDING_SIZE_EXTRA_SMALL : 0),
                  ...
                  ) :orderController.latestOrderList == null ? OrderShimmer(isEnabled: orderController.latestOrderList == null) :
                  orderController.latestOrderList.length > 0 ?
                  _navigateRequestPage() ?
                    Column(
                    children: [
                      OrderRequestWidget(orderModel: orderController.latestOrderList[0], index: 0, onTap: null),
                    ],
                  ) : SizedBox()
               /*   ListView.builder(
                    Colu
                  ...
                  SizedBox(height: _hasActiveOrder ? Dimensions.PADDING_SIZE_DEFAULT : _hascurrentOrder ? Dimensions.PADDING_SIZE_DEFAULT : 0),
                ]);
              }),

           //   (authController.profileModel != null && authController.profileModel.earnings == 1) ?
              Get.find<SplashController>().configModel.showDboyEarningHome ?
              Column(children: [
  ...
  static bool _navigateRequestPage() {
